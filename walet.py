...
def sendMentionFooter(to, text="", mids=[]):
    ...
    cl.sendMessage(to, textx, {'AGENT_NAME':'@zulfahmi78 on Tweeter', 'AGENT_LINK': 'https://www.tweeter.com/zulfahmi78', 'AGENT_ICON': "http://dl.profile.line-cdn.net/" + cl.getProfile().picturePath, 'MENTION': str('{"MENTIONEES":' + json.dumps(arr) + '}')}, 0)
...
def sendMessageWithFooter(to, text):
 ...
 madzs = cl.getProfile()
 ticket = "http://line.me/ti/p/"+zulfahmi78.getUserTicket().id
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               url = 'https://line.me/ti/p/~zulfahmi78'
                               iconlink = 'http://dl.profile.line-cdn.net/{}'.format(str(ma.pictureStatus))
                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 WALET BOT 」\n")
